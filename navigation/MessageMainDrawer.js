...
export function CustomDrawerContentMsg(props) {
      ...
      >
        <SafeAreaView>
          ...
          <DrawerItem
            ...
            labelStyle={styles.drawerItemLabel}
            onPress={() =>
              props.navigation.navigate("MessageStack", { screen: "FIF" })
            }
          />
          ...
          <DrawerItem
            ...
            labelStyle={styles.drawerItemLabel}
            onPress={() =>
              props.navigation.navigate("MessageStack", { screen: "Settings" })
            }
          />
          ...
          <DrawerItem
            ...
            labelStyle={styles.drawerItemLabel}
            onPress={() =>
              props.navigation.navigate("MessageStack", { screen: "Logout" })
            }
          />
