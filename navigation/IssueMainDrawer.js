...
export function CustomDrawerContentIssue(props) {
      ...
      >
        <SafeAreaView>
          ...
          <DrawerItem
            ...
            labelStyle={styles.drawerItemLabel}
            onPress={() =>
              props.navigation.navigate("IssueStack", { screen: "FIF" })
            }
          />
          ...
          <DrawerItem
            ...
            labelStyle={styles.drawerItemLabel}
            onPress={() =>
              props.navigation.navigate("IssueStack", { screen: "Settings" })
            }
          />
          ...
          <DrawerItem
            ...
            labelStyle={styles.drawerItemLabel}
            onPress={() =>
              props.navigation.navigate("IssueStack", { screen: "Logout" })
            }
          />
